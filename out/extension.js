...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('museSpark.stopAgent', () => chatProvider.stopAgent()), vscode.commands.registerCommand('museSpark.newSession', () => chatProvider.newSession()), vscode.commands.registerCommand('museSpark.forkSession', () => chatProvider.forkSession()), vscode.commands.registerCommand('museSpark.listSessions', async () => chatProvider.listSessions()), vscode.commands.registerCommand('museSpark.showDiff', async () => {
